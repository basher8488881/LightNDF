...
class LightNDF(nn.Module):
    ...
    def __init__(self, device, hidden_dim=128):
        ...
        self.conv_0_1 = nn.Conv3d(32, 64, 3, padding=1, padding_mode='zeros')  
        self.conv_1 = nn.Conv3d(64, 64, 3, padding=1, padding_mode='zeros')  
        self.conv_1_1 = nn.Conv3d(64, 128, 3, padding=1, padding_mode='zeros')  
        feature_size = (1 +  16 + 64 + 128 ) * 7 + 3
    ...
    def decoder(self, p, f_0, f_1, f_2, f_3):
        ...
        feature_0 = F.grid_sample(f_0, p, padding_mode='zeros', align_corners=True)
        feature_1 = F.grid_sample(f_1, p, padding_mode='zeros', align_corners=True)
        feature_2 = F.grid_sample(f_2, p, padding_mode='zeros', align_corners=True)
        feature_3 = F.grid_sample(f_3, p, padding_mode='zeros', align_corners=True)
